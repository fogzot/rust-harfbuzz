...
#[doc = " @HB_SCRIPT_KAWI: `Kawi`, Since: 5.2.0"]
#[doc = " @HB_SCRIPT_NAG_MUNDARI: `Nagm`, Since: 5.2.0"]
...
#[doc = "   @HB_MEMORY_MODE_READONLY_MAY_MAKE_WRITABLE, however, using that mode"]
...
#[doc = " @HB_UNICODE_COMBINING_CLASS_CCC132: [Tibetan] Since: 7.2.0"]
...
#[doc = " @draw_data: The data accompanying the draw functions in hb_font_draw_glyph()"]
#[doc = " @st: current draw state"]
#[doc = " @to_x: X component of target point"]
#[doc = " @to_y: Y component of target point"]
#[doc = " @user_data: User data pointer passed to hb_draw_funcs_set_move_to_func()"]
#[doc = ""]
...
#[doc = " @to_x: X component of target point"]
#[doc = " @to_y: Y component of target point"]
#[doc = " @user_data: User data pointer passed to hb_draw_funcs_set_line_to_func()"]
#[doc = ""]
...
#[doc = " @to_x: X component of target point"]
#[doc = " @to_y: Y component of target point"]
#[doc = " @user_data: User data pointer passed to hb_draw_funcs_set_quadratic_to_func()"]
#[doc = ""]
...
#[doc = " @to_x: X component of target point"]
#[doc = " @to_y: Y component of target point"]
#[doc = " @user_data: User data pointer passed to hb_draw_funcs_set_cubic_to_func()"]
#[doc = ""]
...
#[doc = " @draw_data: The data accompanying the draw functions in hb_font_draw_glyph()"]
#[doc = " @st: current draw state"]
#[doc = " @user_data: User data pointer passed to hb_draw_funcs_set_close_path_func()"]
#[doc = ""]
...
#[doc = " @funcs: paint functions object"]
#[doc = " @paint_data: The data accompanying the paint functions in hb_font_paint_glyph()"]
#[doc = " @xx: xx component of the transform matrix"]
#[doc = " @yx: yx component of the transform matrix"]
#[doc = " @xy: xy component of the transform matrix"]
#[doc = " @yy: yy component of the transform matrix"]
#[doc = " @dx: dx component of the transform matrix"]
#[doc = " @dy: dy component of the transform matrix"]
#[doc = " @user_data: User data pointer passed to hb_paint_funcs_set_push_transform_func()"]
#[doc = ""]
#[doc = " A virtual method for the #hb_paint_funcs_t to apply"]
#[doc = " a transform to subsequent paint calls."]
#[doc = ""]
#[doc = " This transform is applied after the current transform,"]
#[doc = " and remains in effect until a matching call to"]
#[doc = " the #hb_paint_funcs_pop_transform_func_t vfunc."]
#[doc = ""]
#[doc = " Since: 7.0.0"]
pub type hb_paint_push_transform_func_t = ::std::option::Option<
    unsafe extern "C" fn(
        ...
        xx: ::std::os::raw::c_float,
        yx: ::std::os::raw::c_float,
        xy: ::std::os::raw::c_float,
        yy: ::std::os::raw::c_float,
...
#[doc = " @funcs: paint functions object"]
#[doc = " @paint_data: The data accompanying the paint functions in hb_font_paint_glyph()"]
#[doc = " @user_data: User data pointer passed to hb_paint_funcs_set_pop_transform_func()"]
#[doc = ""]
#[doc = " A virtual method for the #hb_paint_funcs_t to undo"]
#[doc = " the effect of a prior call to the #hb_paint_funcs_push_transform_func_t"]
#[doc = " vfunc."]
#[doc = ""]
#[doc = " Since: 7.0.0"]
...
#[doc = " @funcs: paint functions object"]
#[doc = " @paint_data: The data accompanying the paint functions in hb_font_paint_glyph()"]
#[doc = " @glyph: the glyph ID"]
#[doc = " @font: the font"]
#[doc = " @user_data: User data pointer passed to hb_paint_funcs_set_push_clip_glyph_func()"]
#[doc = ""]
#[doc = " A virtual method for the #hb_paint_funcs_t to clip"]
#[doc = " subsequent paint calls to the outline of a glyph."]
#[doc = ""]
#[doc = " The coordinates of the glyph outline are interpreted according"]
#[doc = " to the current transform."]
#[doc = ""]
#[doc = " This clip is applied in addition to the current clip,"]
#[doc = " and remains in effect until a matching call to"]
#[doc = " the #hb_paint_funcs_pop_clip_func_t vfunc."]
#[doc = ""]
#[doc = " Since: 7.0.0"]
...
#[doc = " @funcs: paint functions object"]
#[doc = " @paint_data: The data accompanying the paint functions in hb_font_paint_glyph()"]
#[doc = " @xmin: min X for the rectangle"]
#[doc = " @ymin: min Y for the rectangle"]
#[doc = " @xmax: max X for the rectangle"]
#[doc = " @ymax: max Y for the rectangle"]
#[doc = " @user_data: User data pointer passed to hb_paint_funcs_set_push_clip_rectangle_func()"]
#[doc = ""]
#[doc = " A virtual method for the #hb_paint_funcs_t to clip"]
#[doc = " subsequent paint calls to a rectangle."]
#[doc = ""]
#[doc = " The coordinates of the rectangle are interpreted according"]
#[doc = " to the current transform."]
#[doc = ""]
#[doc = " This clip is applied in addition to the current clip,"]
#[doc = " and remains in effect until a matching call to"]
...
pub type hb_paint_push_clip_rectangle_func_t = ::std::option::Option<
    unsafe extern "C" fn(
        funcs: *mut hb_paint_funcs_t,
        paint_data: *mut ::std::os::raw::c_void,
        xmin: ::std::os::raw::c_float,
        ymin: ::std::os::raw::c_float,
        xmax: ::std::os::raw::c_float,
        ymax: ::std::os::raw::c_float,
        user_data: *mut ::std::os::raw::c_void,
    ),
>;
...
#[doc = " @funcs: paint functions object"]
#[doc = " @paint_data: The data accompanying the paint functions in hb_font_paint_glyph()"]
#[doc = " @user_data: User data pointer passed to hb_paint_funcs_set_pop_clip_func()"]
#[doc = ""]
#[doc = " A virtual method for the #hb_paint_funcs_t to undo"]
#[doc = " the effect of a prior call to the #hb_paint_funcs_push_clip_glyph_func_t"]
#[doc = " or #hb_paint_funcs_push_clip_rectangle_func_t vfuncs."]
#[doc = ""]
#[doc = " Since: 7.0.0"]
...
#[doc = " @funcs: paint functions object"]
#[doc = " @paint_data: The data accompanying the paint functions in hb_font_paint_glyph()"]
#[doc = " @is_foreground: whether the color is the foreground"]
#[doc = " @color: The color to use, unpremultiplied"]
#[doc = " @user_data: User data pointer passed to hb_paint_funcs_set_color_func()"]
#[doc = ""]
#[doc = " A virtual method for the #hb_paint_funcs_t to paint a"]
#[doc = " color everywhere within the current clip."]
#[doc = ""]
#[doc = " Since: 7.0.0"]
...
#[doc = " @funcs: paint functions object"]
#[doc = " @paint_data: The data accompanying the paint functions in hb_font_paint_glyph()"]
#[doc = " @image: the image data"]
#[doc = " @width: width of the raster image in pixels, or 0"]
#[doc = " @height: height of the raster image in pixels, or 0"]
#[doc = " @format: the image format as a tag"]
#[doc = " @slant: the synthetic slant ratio to be applied to the image during rendering"]
#[doc = " @extents: (nullable): glyph extents for desired rendering"]
#[doc = " @user_data: User data pointer passed to hb_paint_funcs_set_image_func()"]
#[doc = ""]
#[doc = " A virtual method for the #hb_paint_funcs_t to paint a glyph image."]
#[doc = ""]
#[doc = " This method is called for glyphs with image blobs in the CBDT,"]
#[doc = " sbix or SVG tables. The @format identifies the kind of data that"]
#[doc = " is contained in @image. Possible values include #HB_PAINT_IMAGE_FORMAT_PNG,"]
#[doc = " #HB_PAINT_IMAGE_FORMAT_SVG and #HB_PAINT_IMAGE_FORMAT_BGRA."]
#[doc = ""]
#[doc = " The image dimensions and glyph extents are provided if available,"]
#[doc = " and should be used to size and position the image."]
#[doc = ""]
#[doc = " Return value: Whether the operation was successful."]
#[doc = ""]
#[doc = " Since: 7.0.0"]
pub type hb_paint_image_func_t = ::std::option::Option<
    unsafe extern "C" fn(
        ...
        format: hb_tag_t,
        slant: ::std::os::raw::c_float,
        extents: *mut hb_glyph_extents_t,
        user_data: *mut ::std::os::raw::c_void,
    ) -> hb_bool_t,
>;
#[doc = " hb_color_stop_t:"]
#[doc = " @offset: the offset of the color stop"]
#[doc = " @is_foreground: whether the color is the foreground"]
#[doc = " @color: the color, unpremultiplied"]
#[doc = ""]
#[doc = " Information about a color stop on a color line."]
#[doc = ""]
#[doc = " Color lines typically have offsets ranging between 0 and 1,"]
#[doc = " but that is not required."]
#[doc = ""]
#[doc = " Note: despite @color being unpremultiplied here, interpolation in"]
#[doc = " gradients shall happen in premultiplied space. See the OpenType spec"]
#[doc = " [COLR](https://learn.microsoft.com/en-us/typography/opentype/spec/colr)"]
...
fn bindgen_test_layout_hb_color_stop_t() {
    ...
    fn test_field_offset() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<hb_color_stop_t>::uninit();
                let ptr = uninit.as_ptr();
    ...
    test_field_offset();
    fn test_field_is_foreground() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<hb_color_stop_t>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).is_foreground) as usize - ptr as usize
            },
            4usize,
            concat!(
                "Offset of field: ",
...
#[doc = " @HB_PAINT_EXTEND_PAD: Outside the defined interval,"]
#[doc = "   the color of the closest color stop is used."]
#[doc = " @HB_PAINT_EXTEND_REPEAT: The color line is repeated over"]
#[doc = "   repeated multiples of the defined interval"]
#[doc = " @HB_PAINT_EXTEND_REFLECT: The color line is repeated over"]
#[doc = "      repeated intervals, as for the repeat mode."]
#[doc = "      However, in each repeated interval, the ordering of"]
#[doc = "      color stops is the reverse of the adjacent interval."]
#[doc = ""]
#[doc = " The values of this enumeration determine how color values"]
#[doc = " outside the minimum and maximum defined offset on a #hb_color_line_t"]
#[doc = " are determined."]
#[doc = ""]
#[doc = " See the OpenType spec [COLR](https://learn.microsoft.com/en-us/typography/opentype/spec/colr)"]
#[doc = " section for details."]
#[doc = ""]
#[doc = " Since: 7.0.0"]
pub type hb_paint_extend_t = ::std::os::raw::c_uint;
#[doc = " hb_color_line_get_color_stops_func_t:"]
#[doc = " @color_line: a #hb_color_line_t object"]
#[doc = " @color_line_data: the data accompanying @color_line"]
#[doc = " @start: the index of the first color stop to return"]
#[doc = " @count: (inout) (optional): Input = the maximum number of feature tags to return;"]
#[doc = "     Output = the actual number of feature tags returned (may be zero)"]
#[doc = " @color_stops: (out) (array length=count) (optional): Array of #hb_color_stop_t to populate"]
#[doc = " @user_data: the data accompanying this method"]
#[doc = ""]
#[doc = " A virtual method for the #hb_color_line_t to fetch color stops."]
#[doc = ""]
#[doc = " Return value: the total number of color stops in @color_line"]
#[doc = ""]
#[doc = " Since: 7.0.0"]
...
#[doc = " @user_data: the data accompanying this method"]
#[doc = ""]
#[doc = " A virtual method for the @hb_color_line_t to fetches the extend mode."]
#[doc = ""]
#[doc = " Return value: the extend mode of @color_line"]
#[doc = ""]
#[doc = " Since: 7.0.0"]
...
#[doc = " hb_color_line_t:"]
#[doc = ""]
#[doc = " A struct containing color information for a gradient."]
#[doc = ""]
#[doc = " Since: 7.0.0"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
fn bindgen_test_layout_hb_color_line_t() {
    ...
    fn test_field_data() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<hb_color_line_t>::uninit();
                let ptr = uninit.as_ptr();
    ...
    test_field_data();
    fn test_field_get_color_stops() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<hb_color_line_t>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).get_color_stops) as usize - ptr as usize
            },
            8usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_get_color_stops();
    fn test_field_get_color_stops_user_data() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<hb_color_line_t>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).get_color_stops_user_data) as usize - ptr as usize
            },
            16usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_get_color_stops_user_data();
    fn test_field_get_extend() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<hb_color_line_t>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).get_extend) as usize - ptr as usize
            },
            24usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_get_extend();
    fn test_field_get_extend_user_data() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<hb_color_line_t>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).get_extend_user_data) as usize - ptr as usize
            },
            32usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_get_extend_user_data();
...
#[doc = " @funcs: paint functions object"]
#[doc = " @paint_data: The data accompanying the paint functions in hb_font_paint_glyph()"]
#[doc = " @color_line: Color information for the gradient"]
#[doc = " @x0: X coordinate of the first point"]
#[doc = " @y0: Y coordinate of the first point"]
#[doc = " @x1: X coordinate of the second point"]
#[doc = " @y1: Y coordinate of the second point"]
#[doc = " @x2: X coordinate of the third point"]
#[doc = " @y2: Y coordinate of the third point"]
#[doc = " @user_data: User data pointer passed to hb_paint_funcs_set_linear_gradient_func()"]
#[doc = ""]
#[doc = " A virtual method for the #hb_paint_funcs_t to paint a linear"]
#[doc = " gradient everywhere within the current clip."]
#[doc = ""]
#[doc = " The @color_line object contains information about the colors of the gradients."]
#[doc = " It is only valid for the duration of the callback, you cannot keep it around."]
#[doc = ""]
#[doc = " The coordinates of the points are interpreted according"]
#[doc = " to the current transform."]
#[doc = ""]
#[doc = " See the OpenType spec [COLR](https://learn.microsoft.com/en-us/typography/opentype/spec/colr)"]
#[doc = " section for details on how the points define the direction"]
#[doc = " of the gradient, and how to interpret the @color_line."]
#[doc = ""]
#[doc = " Since: 7.0.0"]
...
#[doc = " @paint_data: The data accompanying the paint functions in hb_font_paint_glyph()"]
#[doc = " @color_line: Color information for the gradient"]
#[doc = " @x0: X coordinate of the first circle's center"]
#[doc = " @y0: Y coordinate of the first circle's center"]
#[doc = " @r0: radius of the first circle"]
#[doc = " @x1: X coordinate of the second circle's center"]
#[doc = " @y1: Y coordinate of the second circle's center"]
#[doc = " @r1: radius of the second circle"]
#[doc = " @user_data: User data pointer passed to hb_paint_funcs_set_radial_gradient_func()"]
#[doc = ""]
#[doc = " A virtual method for the #hb_paint_funcs_t to paint a radial"]
#[doc = " gradient everywhere within the current clip."]
#[doc = ""]
#[doc = " The @color_line object contains information about the colors of the gradients."]
#[doc = " It is only valid for the duration of the callback, you cannot keep it around."]
...
pub type hb_paint_radial_gradient_func_t = ::std::option::Option<
    unsafe extern "C" fn(
        ...
        x0: ::std::os::raw::c_float,
        y0: ::std::os::raw::c_float,
        r0: ::std::os::raw::c_float,
        x1: ::std::os::raw::c_float,
        y1: ::std::os::raw::c_float,
        r1: ::std::os::raw::c_float,
        user_data: *mut ::std::os::raw::c_void,
    ),
>;
...
#[doc = " @paint_data: The data accompanying the paint functions in hb_font_paint_glyph()"]
#[doc = " @color_line: Color information for the gradient"]
#[doc = " @x0: X coordinate of the circle's center"]
#[doc = " @y0: Y coordinate of the circle's center"]
#[doc = " @start_angle: the start angle, in radians"]
#[doc = " @end_angle: the end angle, in radians"]
#[doc = " @user_data: User data pointer passed to hb_paint_funcs_set_sweep_gradient_func()"]
#[doc = ""]
#[doc = " A virtual method for the #hb_paint_funcs_t to paint a sweep"]
#[doc = " gradient everywhere within the current clip."]
#[doc = ""]
#[doc = " The @color_line object contains information about the colors of the gradients."]
#[doc = " It is only valid for the duration of the callback, you cannot keep it around."]
...
pub type hb_paint_sweep_gradient_func_t = ::std::option::Option<
    unsafe extern "C" fn(
        ...
        x0: ::std::os::raw::c_float,
        y0: ::std::os::raw::c_float,
        start_angle: ::std::os::raw::c_float,
        end_angle: ::std::os::raw::c_float,
        user_data: *mut ::std::os::raw::c_void,
    ),
>;
...
#[doc = " @HB_PAINT_COMPOSITE_MODE_CLEAR: clear destination layer (bounded)"]
#[doc = " @HB_PAINT_COMPOSITE_MODE_SRC: replace destination layer (bounded)"]
#[doc = " @HB_PAINT_COMPOSITE_MODE_SRC_OVER: draw source layer on top of destination layer"]
#[doc = " (bounded)"]
#[doc = " @HB_PAINT_COMPOSITE_MODE_SRC_IN: draw source where there was destination content"]
#[doc = " (unbounded)"]
#[doc = " @HB_PAINT_COMPOSITE_MODE_SRC_OUT: draw source where there was no destination"]
#[doc = " content (unbounded)"]
#[doc = " @HB_PAINT_COMPOSITE_MODE_SRC_ATOP: draw source on top of destination content and"]
#[doc = " only there"]
#[doc = " @HB_PAINT_COMPOSITE_MODE_DEST: ignore the source"]
#[doc = " @HB_PAINT_COMPOSITE_MODE_DEST_OVER: draw destination on top of source"]
#[doc = " @HB_PAINT_COMPOSITE_MODE_DEST_IN: leave destination only where there was"]
#[doc = " source content (unbounded)"]
#[doc = " @HB_PAINT_COMPOSITE_MODE_DEST_OUT: leave destination only where there was no"]
#[doc = " source content"]
#[doc = " @HB_PAINT_COMPOSITE_MODE_DEST_ATOP: leave destination on top of source content"]
#[doc = " and only there (unbounded)"]
#[doc = " @HB_PAINT_COMPOSITE_MODE_XOR: source and destination are shown where there is only"]
#[doc = " one of them"]
#[doc = " @HB_PAINT_COMPOSITE_MODE_PLUS: source and destination layers are accumulated"]
#[doc = " @HB_PAINT_COMPOSITE_MODE_MULTIPLY: source and destination layers are multiplied."]
#[doc = " This causes the result to be at least as dark as the darker inputs."]
#[doc = " @HB_PAINT_COMPOSITE_MODE_SCREEN: source and destination are complemented and"]
#[doc = " multiplied. This causes the result to be at least as light as the lighter"]
#[doc = " inputs."]
#[doc = " @HB_PAINT_COMPOSITE_MODE_OVERLAY: multiplies or screens, depending on the"]
#[doc = " lightness of the destination color."]
#[doc = " @HB_PAINT_COMPOSITE_MODE_DARKEN: replaces the destination with the source if it"]
#[doc = " is darker, otherwise keeps the source."]
#[doc = " @HB_PAINT_COMPOSITE_MODE_LIGHTEN: replaces the destination with the source if it"]
#[doc = " is lighter, otherwise keeps the source."]
#[doc = " @HB_PAINT_COMPOSITE_MODE_COLOR_DODGE: brightens the destination color to reflect"]
#[doc = " the source color."]
#[doc = " @HB_PAINT_COMPOSITE_MODE_COLOR_BURN: darkens the destination color to reflect"]
#[doc = " the source color."]
#[doc = " @HB_PAINT_COMPOSITE_MODE_HARD_LIGHT: Multiplies or screens, dependent on source"]
#[doc = " color."]
#[doc = " @HB_PAINT_COMPOSITE_MODE_SOFT_LIGHT: Darkens or lightens, dependent on source"]
#[doc = " color."]
#[doc = " @HB_PAINT_COMPOSITE_MODE_DIFFERENCE: Takes the difference of the source and"]
#[doc = " destination color."]
#[doc = " @HB_PAINT_COMPOSITE_MODE_EXCLUSION: Produces an effect similar to difference, but"]
#[doc = " with lower contrast."]
#[doc = " @HB_PAINT_COMPOSITE_MODE_HSL_HUE: Creates a color with the hue of the source"]
#[doc = " and the saturation and luminosity of the target."]
#[doc = " @HB_PAINT_COMPOSITE_MODE_HSL_SATURATION: Creates a color with the saturation"]
#[doc = " of the source and the hue and luminosity of the target. Painting with"]
#[doc = " this mode onto a gray area produces no change."]
#[doc = " @HB_PAINT_COMPOSITE_MODE_HSL_COLOR: Creates a color with the hue and saturation"]
...
#[doc = " tinting color images."]
#[doc = " @HB_PAINT_COMPOSITE_MODE_HSL_LUMINOSITY: Creates a color with the luminosity of"]
#[doc = " the source and the hue and saturation of the target. This produces an"]
#[doc = " inverse effect to @HB_PAINT_COMPOSITE_MODE_HSL_COLOR."]
#[doc = ""]
#[doc = " The values of this enumeration describe the compositing modes"]
#[doc = " that can be used when combining temporary redirected drawing"]
#[doc = " with the backdrop."]
#[doc = ""]
#[doc = " See the OpenType spec [COLR](https://learn.microsoft.com/en-us/typography/opentype/spec/colr)"]
#[doc = " section for details."]
#[doc = ""]
...
#[doc = " @funcs: paint functions object"]
#[doc = " @paint_data: The data accompanying the paint functions in hb_font_paint_glyph()"]
#[doc = " @user_data: User data pointer passed to hb_paint_funcs_set_push_group_func()"]
#[doc = ""]
#[doc = " A virtual method for the #hb_paint_funcs_t to use"]
#[doc = " an intermediate surface for subsequent paint calls."]
#[doc = ""]
#[doc = " The drawing will be redirected to an intermediate surface"]
#[doc = " until a matching call to the #hb_paint_funcs_pop_group_func_t"]
#[doc = " vfunc."]
#[doc = ""]
#[doc = " Since: 7.0.0"]
...
#[doc = " @funcs: paint functions object"]
#[doc = " @paint_data: The data accompanying the paint functions in hb_font_paint_glyph()"]
#[doc = " @mode: the compositing mode to use"]
#[doc = " @user_data: User data pointer passed to hb_paint_funcs_set_pop_group_func()"]
#[doc = ""]
#[doc = " A virtual method for the #hb_paint_funcs_t to undo"]
#[doc = " the effect of a prior call to the #hb_paint_funcs_push_group_func_t"]
#[doc = " vfunc."]
#[doc = ""]
#[doc = " This call stops the redirection to the intermediate surface,"]
#[doc = " and then composites it on the previous surface, using the"]
#[doc = " compositing mode passed to this call."]
#[doc = ""]
#[doc = " Since: 7.0.0"]
...
#[doc = " @funcs: paint functions object"]
#[doc = " @paint_data: The data accompanying the paint functions in hb_font_paint_glyph()"]
#[doc = " @color_index: the color index"]
#[doc = " @color: (out): fetched color"]
#[doc = " @user_data: User data pointer passed to hb_paint_funcs_set_pop_group_func()"]
#[doc = ""]
#[doc = " A virtual method for the #hb_paint_funcs_t to fetch a color from the custom"]
#[doc = " color palette."]
#[doc = ""]
#[doc = " Custom palette colors override the colors from the fonts selected color"]
#[doc = " palette. It is not necessary to override all palette entries; for entries"]
#[doc = " that should be taken from the font palette, return `false`."]
#[doc = ""]
#[doc = " This function might get called multiple times, but the custom palette is"]
#[doc = " expected to remain unchanged for duration of a hb_font_paint_glyph() call."]
#[doc = ""]
#[doc = " Return value: `true` if found, `false` otherwise"]
#[doc = ""]
#[doc = " Since: 7.0.0"]
...
extern "C" {
    ...
    #[doc = " @funcs: A paint functions struct"]
    #[doc = " @func: (closure user_data) (destroy destroy) (scope notified): The push-transform callback"]
    #[doc = " @user_data: Data to pass to @func"]
    #[doc = " @destroy: (nullable): Function to call when @user_data is no longer needed"]
    #[doc = ""]
    #[doc = " Sets the push-transform callback on the paint functions struct."]
    #[doc = ""]
    #[doc = " Since: 7.0.0"]
...
extern "C" {
    ...
    #[doc = " @funcs: A paint functions struct"]
    #[doc = " @func: (closure user_data) (destroy destroy) (scope notified): The pop-transform callback"]
    #[doc = " @user_data: Data to pass to @func"]
    #[doc = " @destroy: (nullable): Function to call when @user_data is no longer needed"]
    #[doc = ""]
    #[doc = " Sets the pop-transform callback on the paint functions struct."]
    #[doc = ""]
    #[doc = " Since: 7.0.0"]
...
extern "C" {
    ...
    #[doc = " @funcs: A paint functions struct"]
    #[doc = " @func: (closure user_data) (destroy destroy) (scope notified): The push-clip-glyph callback"]
    #[doc = " @user_data: Data to pass to @func"]
    #[doc = " @destroy: (nullable): Function to call when @user_data is no longer needed"]
    #[doc = ""]
    #[doc = " Sets the push-clip-glyph callback on the paint functions struct."]
    #[doc = ""]
    #[doc = " Since: 7.0.0"]
...
extern "C" {
    ...
    #[doc = " @funcs: A paint functions struct"]
    #[doc = " @func: (closure user_data) (destroy destroy) (scope notified): The push-clip-rectangle callback"]
    #[doc = " @user_data: Data to pass to @func"]
    #[doc = " @destroy: (nullable): Function to call when @user_data is no longer needed"]
    #[doc = ""]
    #[doc = " Sets the push-clip-rect callback on the paint functions struct."]
    #[doc = ""]
    #[doc = " Since: 7.0.0"]
...
extern "C" {
    ...
    #[doc = " @funcs: A paint functions struct"]
    #[doc = " @func: (closure user_data) (destroy destroy) (scope notified): The pop-clip callback"]
    #[doc = " @user_data: Data to pass to @func"]
    #[doc = " @destroy: (nullable): Function to call when @user_data is no longer needed"]
    #[doc = ""]
    #[doc = " Sets the pop-clip callback on the paint functions struct."]
    #[doc = ""]
    #[doc = " Since: 7.0.0"]
...
extern "C" {
    ...
    #[doc = " @funcs: A paint functions struct"]
    #[doc = " @func: (closure user_data) (destroy destroy) (scope notified): The paint-color callback"]
    #[doc = " @user_data: Data to pass to @func"]
    #[doc = " @destroy: (nullable): Function to call when @user_data is no longer needed"]
    #[doc = ""]
    #[doc = " Sets the paint-color callback on the paint functions struct."]
    #[doc = ""]
    #[doc = " Since: 7.0.0"]
...
extern "C" {
    ...
    #[doc = " @funcs: A paint functions struct"]
    #[doc = " @func: (closure user_data) (destroy destroy) (scope notified): The paint-image callback"]
    #[doc = " @user_data: Data to pass to @func"]
    #[doc = " @destroy: (nullable): Function to call when @user_data is no longer needed"]
    #[doc = ""]
    #[doc = " Sets the paint-image callback on the paint functions struct."]
    #[doc = ""]
    #[doc = " Since: 7.0.0"]
...
extern "C" {
    ...
    #[doc = " @funcs: A paint functions struct"]
    #[doc = " @func: (closure user_data) (destroy destroy) (scope notified): The linear-gradient callback"]
    #[doc = " @user_data: Data to pass to @func"]
    #[doc = " @destroy: (nullable): Function to call when @user_data is no longer needed"]
    #[doc = ""]
    #[doc = " Sets the linear-gradient callback on the paint functions struct."]
    #[doc = ""]
    #[doc = " Since: 7.0.0"]
...
extern "C" {
    ...
    #[doc = " @funcs: A paint functions struct"]
    #[doc = " @func: (closure user_data) (destroy destroy) (scope notified): The radial-gradient callback"]
    #[doc = " @user_data: Data to pass to @func"]
    #[doc = " @destroy: (nullable): Function to call when @user_data is no longer needed"]
    #[doc = ""]
    #[doc = " Sets the radial-gradient callback on the paint functions struct."]
    #[doc = ""]
    #[doc = " Since: 7.0.0"]
...
extern "C" {
    ...
    #[doc = " @funcs: A paint functions struct"]
    #[doc = " @func: (closure user_data) (destroy destroy) (scope notified): The sweep-gradient callback"]
    #[doc = " @user_data: Data to pass to @func"]
    #[doc = " @destroy: (nullable): Function to call when @user_data is no longer needed"]
    #[doc = ""]
    #[doc = " Sets the sweep-gradient callback on the paint functions struct."]
    #[doc = ""]
    #[doc = " Since: 7.0.0"]
...
extern "C" {
    ...
    #[doc = " @funcs: A paint functions struct"]
    #[doc = " @func: (closure user_data) (destroy destroy) (scope notified): The push-group callback"]
    #[doc = " @user_data: Data to pass to @func"]
    #[doc = " @destroy: (nullable): Function to call when @user_data is no longer needed"]
    #[doc = ""]
    #[doc = " Sets the push-group callback on the paint functions struct."]
    #[doc = ""]
    #[doc = " Since: 7.0.0"]
...
extern "C" {
    ...
    #[doc = " @funcs: A paint functions struct"]
    #[doc = " @func: (closure user_data) (destroy destroy) (scope notified): The pop-group callback"]
    #[doc = " @user_data: Data to pass to @func"]
    #[doc = " @destroy: (nullable): Function to call when @user_data is no longer needed"]
    #[doc = ""]
    #[doc = " Sets the pop-group callback on the paint functions struct."]
    #[doc = ""]
    #[doc = " Since: 7.0.0"]
...
extern "C" {
    ...
    #[doc = " @funcs: A paint functions struct"]
    #[doc = " @func: (closure user_data) (destroy destroy) (scope notified): The custom-palette-color callback"]
    #[doc = " @user_data: Data to pass to @func"]
    #[doc = " @destroy: (nullable): Function to call when @user_data is no longer needed"]
    #[doc = ""]
    #[doc = " Sets the custom-palette-color callback on the paint functions struct."]
    #[doc = ""]
    #[doc = " Since: 7.0.0"]
...
#[doc = " @font_data: @font user data pointer"]
#[doc = " @glyph: The glyph ID to query"]
#[doc = " @paint_funcs: The paint functions to use"]
#[doc = " @paint_data: The data accompanying the paint functions"]
#[doc = " @palette_index: The color palette to use"]
#[doc = " @foreground: The foreground color"]
#[doc = " @user_data: User data pointer passed by the caller"]
#[doc = ""]
#[doc = " A virtual method for the #hb_font_funcs_t of an #hb_font_t object."]
#[doc = ""]
...
extern "C" {
    ...
    #[doc = " @destroy: (nullable): The function to call when @user_data is not needed anymore"]
    #[doc = ""]
    #[doc = " Sets the implementation function for #hb_font_draw_glyph_func_t."]
    #[doc = ""]
    #[doc = " Since: 7.0.0"]
...
extern "C" {
    ...
    #[doc = " @func: (closure user_data) (destroy destroy) (scope notified): The callback function to assign"]
    #[doc = " @user_data: Data to pass to @func"]
    #[doc = " @destroy: (nullable): The function to call when @user_data is no longer needed"]
    #[doc = ""]
    #[doc = " Sets the implementation function for #hb_font_paint_glyph_func_t."]
    #[doc = ""]
    #[doc = " Since: 7.0.0"]
...
extern "C" {
    pub fn hb_font_set_synthetic_bold(
        font: *mut hb_font_t,
        x_embolden: ::std::os::raw::c_float,
        y_embolden: ::std::os::raw::c_float,
        in_place: hb_bool_t,
    );
}
extern "C" {
    pub fn hb_font_get_synthetic_bold(
        font: *mut hb_font_t,
        x_embolden: *mut ::std::os::raw::c_float,
        y_embolden: *mut ::std::os::raw::c_float,
...
extern "C" {
    pub fn hb_font_set_variation(font: *mut hb_font_t, tag: hb_tag_t, value: ::std::os::raw::c_float);
}
extern "C" {
...
#[doc = " \t\t\t\t   Since: 4.0.0"]
#[doc = " @HB_GLYPH_FLAG_SAFE_TO_INSERT_TATWEEL: In scripts that use elongation (Arabic,"]
#[doc = "Mongolian, Syriac, etc.), this flag signifies"]
#[doc = "that it is safe to insert a U+0640 TATWEEL"]
#[doc = "character before this cluster for elongation."]
#[doc = "This flag does not determine the"]
#[doc = "script-specific elongation places, but only"]
#[doc = "when it is safe to do the elongation without"]
#[doc = "interrupting text shaping."]
#[doc = "Since: 5.1.0"]
...
#[doc = " @HB_BUFFER_FLAG_PRODUCE_SAFE_TO_INSERT_TATWEEL:"]
#[doc = "                      flag indicating that the @HB_GLYPH_FLAG_SAFE_TO_INSERT_TATWEEL"]
#[doc = "                      glyph-flag should be produced by the shaper. By default"]
#[doc = "                      it will not be produced. Since: 5.1.0"]
...
#[doc = ""]
#[doc = " Since: 4.0.0"]
#[doc = " Deprecated: 7.0.0: Use #hb_font_draw_glyph_func_t instead"]
...
extern "C" {
    ...
    #[doc = " which is the same as #hb_font_draw_glyph_func_t."]
    #[doc = ""]
    #[doc = " Since: 4.0.0"]
    #[doc = " Deprecated: 7.0.0: Use hb_font_funcs_set_draw_glyph_func() instead"]
...
extern "C" {
    pub fn hb_shape_justify(
        ...
        num_features: ::std::os::raw::c_uint,
        shaper_list: *const *const ::std::os::raw::c_char,
        min_target_advance: ::std::os::raw::c_float,
        max_target_advance: ::std::os::raw::c_float,
        advance: *mut ::std::os::raw::c_float,
        var_tag: *mut hb_tag_t,
        var_value: *mut ::std::os::raw::c_float,
    ) -> hb_bool_t;
}
extern "C" {
...
#[doc = " @HB_OT_NAME_ID_COPYRIGHT: Copyright notice"]
#[doc = " @HB_OT_NAME_ID_FONT_FAMILY: Font Family name"]
#[doc = " @HB_OT_NAME_ID_FONT_SUBFAMILY: Font Subfamily name"]
#[doc = " @HB_OT_NAME_ID_UNIQUE_ID: Unique font identifier"]
#[doc = " @HB_OT_NAME_ID_FULL_NAME: Full font name that reflects"]
#[doc = " all family and relevant subfamily descriptors"]
#[doc = " @HB_OT_NAME_ID_VERSION_STRING: Version string"]
#[doc = " @HB_OT_NAME_ID_POSTSCRIPT_NAME: PostScript name for the font"]
#[doc = " @HB_OT_NAME_ID_TRADEMARK: Trademark"]
#[doc = " @HB_OT_NAME_ID_MANUFACTURER: Manufacturer Name"]
#[doc = " @HB_OT_NAME_ID_DESIGNER: Designer"]
#[doc = " @HB_OT_NAME_ID_DESCRIPTION: Description"]
#[doc = " @HB_OT_NAME_ID_VENDOR_URL: URL of font vendor"]
#[doc = " @HB_OT_NAME_ID_DESIGNER_URL: URL of typeface designer"]
#[doc = " @HB_OT_NAME_ID_LICENSE: License Description"]
#[doc = " @HB_OT_NAME_ID_LICENSE_URL: URL where additional licensing"]
#[doc = " information can be found"]
#[doc = " @HB_OT_NAME_ID_TYPOGRAPHIC_FAMILY: Typographic Family name"]
#[doc = " @HB_OT_NAME_ID_TYPOGRAPHIC_SUBFAMILY: Typographic Subfamily name"]
#[doc = " @HB_OT_NAME_ID_MAC_FULL_NAME: Compatible Full Name for MacOS"]
#[doc = " @HB_OT_NAME_ID_SAMPLE_TEXT: Sample text"]
#[doc = " @HB_OT_NAME_ID_CID_FINDFONT_NAME: PostScript CID findfont name"]
#[doc = " @HB_OT_NAME_ID_WWS_FAMILY: WWS Family Name"]
#[doc = " @HB_OT_NAME_ID_WWS_SUBFAMILY: WWS Subfamily Name"]
#[doc = " @HB_OT_NAME_ID_LIGHT_BACKGROUND: Light Background Palette"]
#[doc = " @HB_OT_NAME_ID_DARK_BACKGROUND: Dark Background Palette"]
#[doc = " @HB_OT_NAME_ID_VARIATIONS_PS_PREFIX: Variations PostScript Name Prefix"]
#[doc = " @HB_OT_NAME_ID_INVALID: Value to represent a nonexistent name ID."]
#[doc = ""]
#[doc = " An enum type representing the pre-defined name IDs."]
#[doc = ""]
#[doc = " For more information on these fields, see the"]
#[doc = " [OpenType spec](https://docs.microsoft.com/en-us/typography/opentype/spec/name#name-ids)."]
#[doc = ""]
#[doc = " Since: 7.0.0"]
pub type hb_ot_name_id_predefined_t = ::std::os::raw::c_uint;
#[doc = " hb_ot_name_id_t:"]
#[doc = ""]
#[doc = " An integral type representing an OpenType 'name' table name identifier."]
#[doc = " There are predefined name IDs, as well as name IDs return from other"]
#[doc = " API.  These can be used to fetch name strings from a font face."]
#[doc = ""]
#[doc = " Since: 2.0.0"]
...
#[doc = ""]
#[doc = " A color index of 0xFFFF does not refer to a palette"]
#[doc = " color, but indicates that the foreground color should"]
#[doc = " be used."]
#[doc = ""]
#[doc = " Since: 2.1.0"]
#[repr(C)]
